...
const Pricing = () => {
  ...
  return (
    <>
    {/* pricing */}
    <section className="w-full flex flex-col items-center bg-[linear-gradient(to_bottom,#c6d6fa40_65%,white_50%)]" id="pricing-hero">
      <h2 className="text-4xl font-bold pt-24 text-center text-textBlue mb-3">
      ...
      <div className="flex flex-col md:flex-row gap-8 p-6 md:p-20 mt-2 items-center justify-center">
        {plans.map((plan) => (
          <div
            key={plan.name}
    ...
    {/* Frequently asked question */}
      <section className="max-w-4xl mx-auto px-6 py-20" id="pricing-faq">
        <h2 className="text-3xl text-textBlue font-bold text-center mb-12">Frequently Asked <span className="text-primaryRed"> Questions </span></h2>
